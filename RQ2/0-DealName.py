...
if os.path.isfile(r"D:\\CCFinder\\outName.txt"):
    os.remove(r"D:\\CCFinder\\outName.txt")
...
for project in tqdm(projects):
    ...
    def readCommit(fileInfo):
        ...
        path = path.replace('D:/NewData','D:/CCFinder/message')
        path = path + '/0.txt'
        ...
        if line == 'source_files {\n':
            while 1:
                ...
                if "NewData" in listName[1]:
                    listName[1] = listName[1].replace('F:\\', 'D:\\')
                    ...
                    path = path.replace('D:/NewData','D:/CCFinder/message')
                    path = path + '/0.txt'
                    path = path.replace('D:/CCFinder/message','E:/NewData')
...
Output = open(r"./outName.txt",'a+',encoding='UTF-8')
for i in hashName:
